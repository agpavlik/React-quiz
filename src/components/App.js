...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "restart":
      return { ...initialState, questions: state.questions, status: "ready" }; // variant 1 with saving questions
    // return { state, points: 0, highscore: 0, index: 0, answer: null, status: "ready" }; // variant 2
    default:
